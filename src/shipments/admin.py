...
class ServiceTypeAdmin(admin.ModelAdmin):
    list_display = ['name', 'code', 'base_rate', 'rate_per_kg', 'estimated_days_min', 'estimated_days_max', 'is_active']
    list_filter = ['is_active']


@admin.register(Shipment)
class ShipmentAdmin(admin.ModelAdmin):
    list_display = ['tracking_number', 'user', 'status', 'service_type', 'estimated_cost', 'created_at']
...
class WebhookAdmin(admin.ModelAdmin):
    list_display = ['user', 'url', 'event', 'is_active', 'created_at']
