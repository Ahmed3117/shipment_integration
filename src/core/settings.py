...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'accounts.authentication.CompanyTokenAuthentication',  # Company token auth first
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # JWT for carriers/admins
    ],
